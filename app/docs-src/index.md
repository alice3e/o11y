...
- **[🔍 Jaeger](http://51.250.7.79:16686/)** - распределенный трейсинг и анализ производительности
- **[📈 Grafana](http://51.250.7.79:3000)** - дашборды и мониторинг (admin, admin)
- **[⚡ Performance Profiles](http://51.250.7.79/profiles/)** - веб-сервер с файлами профилирования для SnakeViz
- **[📖 Документация](http://51.250.7.79/docs/)** - полная техническая документация проекта
- **[🚀 Locust](http://51.250.7.79/locust/)** - нагрузочное тестирование и симуляция пользователей
- **[📊 Prometheus](http://51.250.7.79:9090/targets)** - метрики и мониторинг целей
- **[📋 Swagger API](http://51.250.7.79/swagger/)** - интерактивная документация и тестирование API
